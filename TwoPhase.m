...
C=[-7.5 3 0 0 0 0];% sabki cost,saare variables
% without artifcial variables but with sol
A=[3 -1 -1 -1 0 1 0 3; 1 -1 1 0 -1 0 1 2];%complete matrix 
BV=[6 7];
Cost=[0 0 0 0 0 -1 -1 0]; %cost of phase one Z=-A1-A2

StartBV=find(Cost<0); 
%start basic variables are artificial variables
% and their value is -1 which is less than 0
fprintf('***PHASE 1**\n');
[BFS,A]=simp(A,BV,Cost,Variables); %D is the cost 
fprintf('***PHASE 2**\n');
